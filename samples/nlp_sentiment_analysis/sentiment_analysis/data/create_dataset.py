...
def main():
    ...
    system("mkdir 'data'")
    imdb_train.to_csv("data/raw/imdb_train.data", index=False)
    imdb_test.to_csv("data/raw/imdb_test.data", index=False)

    # imdb_train = pd.read_csv('data/imdb_train.data')
    # imdb_test = pd.read_csv('data/imdb_test.data')
